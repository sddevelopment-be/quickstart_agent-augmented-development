...
def logger_with_data(temp_db):
    ...
    sample_data = [
        ("inv-001", "agent-a", "claude-code", "claude-3.5-sonnet", 100, 200, 0.015, 1500, "success", today),
        ("inv-002", "agent-a", "cursor", "gpt-4-turbo", 150, 250, 0.020, 1800, "success", today),
        ("inv-003", "agent-b", "claude-code", "claude-3.5-sonnet", 120, 220, 0.016, 1600, "error", today),
        ("inv-004", "agent-a", "claude-code", "claude-3.5-sonnet", 110, 210, 0.015, 1550, "success", yesterday),
    ]
    
    for inv_id, agent, tool, model, prompt_tok, compl_tok, cost, latency, status, date in sample_data:
