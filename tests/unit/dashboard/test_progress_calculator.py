...
class TestFeatureProgressCalculation:
    ...
    def test_calculate_progress_all_done(self):
        ...
        pytest.skip(
            "Implementation pending: ProgressCalculator.calculate_feature_progress"
        )
...
class TestInitiativeProgressCalculation:
    ...
    def test_calculate_initiative_progress_from_features(self):
        ...
        pytest.skip(
            "Implementation pending: ProgressCalculator.calculate_initiative_progress"
        )
    ...
    def test_weighted_feature_progress(self):
        ...
        pytest.skip(
            "Implementation pending: Weighted feature progress (future enhancement)"
        )
