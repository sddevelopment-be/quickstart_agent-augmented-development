...
class TestDashboardApp:
    ...
    def test_config_override(self):
        ...
        custom_config = {"TESTING": True, "SECRET_KEY": "test-secret"}
...
class TestDashboardAPIFiltering:
    ...
    def test_tasks_finished_endpoint(self):
        ...
        with patch(
            "llm_service.dashboard.app.load_tasks_with_filter"
        ) as mock_load_filtered:
            ...
            mock_load_filtered.assert_called_once_with(
                ANY, include_done=True, terminal_only=True
            )
