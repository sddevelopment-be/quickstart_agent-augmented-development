...
class TestPriorityEditingAPI:
    ...
    def test_patch_endpoint_exists(self, app):
        ...
        with patch('llm_service.dashboard.task_priority_updater.TaskPriorityUpdater') as mock_updater:
            mock_instance = Mock()
    ...
    def test_concurrent_modification_returns_409(self, app):
        ...
        with patch('llm_service.dashboard.task_priority_updater.TaskPriorityUpdater') as mock_updater:
            ...
            from llm_service.dashboard.task_priority_updater import ConcurrentModificationError
            ...
            mock_instance.validate_priority.return_value = None
            mock_instance.is_editable_status.return_value = True
            mock_instance.update_task_priority.side_effect = ConcurrentModificationError(
    ...
    def test_security_headers_present_in_response(self, app):
        ...
        with patch('llm_service.dashboard.task_priority_updater.TaskPriorityUpdater') as mock_updater:
            ...
            assert 'Content-Security-Policy' in response.headers or response.status_code in [200, 400]
