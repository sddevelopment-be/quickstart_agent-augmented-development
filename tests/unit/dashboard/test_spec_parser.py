...
"""
        ...
        assert (
            metadata.relative_path == "dashboard/feature.md"
    ...
    def test_parse_specification_with_rglob_absolute_paths(self, tmp_path: Path):
        ...
        initiatives_dir = (
            tmp_path / "specifications" / "initiatives" / "dashboard-enhancements"
        )
...
"""
        ...
        assert (
            spec.relative_path
            == "initiatives/dashboard-enhancements/real-time-execution-dashboard.md"
        ...
        assert (
            expected_task_link
            == "specifications/initiatives/dashboard-enhancements/real-time-execution-dashboard.md"
...
class TestSpecificationMetadataModel:
    ...
    def test_metadata_with_features(self):
        ...
        from src.llm_service.dashboard.spec_parser import Feature, SpecificationMetadata
