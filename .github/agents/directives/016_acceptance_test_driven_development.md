...
- Exception: trivial throw-away utilities or single-use shell scripts (log exception in work log and reference ADR-012).
...
4. Use the Testing Pyramid to balance coverage: few but meaningful acceptance tests per capability.
5. Once acceptance tests fail for the right reason, delegate detailed work to TDD cycles.
