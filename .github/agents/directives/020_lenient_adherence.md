...
**Purpose:** Define five leniency levels so agents and humans can calibrate how strictly they must follow templates, checklists, or procedures when responding to a task. Leniency governs structural adherence, not overall integrity—Operational and Strategic rules always apply.
