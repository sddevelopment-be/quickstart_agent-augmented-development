# 016 Traceable Decisions Directive
...
1. **Load ADR Index:** Read `docs/architecture/adrs/README.md` to identify relevant decisions
...
Step 1: Load docs/architecture/adrs/README.md
...
result:
  ...
  artefacts:
    - "docs/architecture/protocols/agent-handoff.md"
  decision_rationale:
    adr: "ADR-008"
...
- **Documentation:** `docs/architecture/protocols/handoff.md`
- **Directives:** `.github/agents/directives/012_operating_procedures.md`
- **Templates:** `docs/templates/agent-tasks/task-base.yaml`
```
...
Agent: "Found 5 decision markers related to coordination patterns.
        ...
        May I create synthesis document in docs/architecture/synthesis/?"
```
...
→ Search docs/architecture/adrs/README.md for "authentication"
...
→ rg "Decision.*error" docs/architecture/
...
result:
  ...
  artefacts:
    - "docs/architecture/protocols/handoff-error-recovery.md"
...
Added full decision marker to `docs/architecture/protocols/handoff-error-recovery.md`:
...
**Source ADR:** [ADR-014: Traceable Decision Integration](../../docs/architecture/adrs/ADR-014-traceable-decision-integration.md)
