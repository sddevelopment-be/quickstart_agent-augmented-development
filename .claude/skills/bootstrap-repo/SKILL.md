...
1. Summarize next 5 refinement actions.

## Inputs

- **VISION** (required) - paragraph
- **SCOPE** (required) - in/out bullets
- **OUTCOMES** (required) - bullets
- **LANGUAGE** (required) - Primary Language
- **STACK** (required) - bullets
- **COMM_PREFS** (required) - bullets
- **CONSTRAINTS** (required) - bullets
- **ROLES** (required) - bullets
- **REFS** (required) - paths/links
