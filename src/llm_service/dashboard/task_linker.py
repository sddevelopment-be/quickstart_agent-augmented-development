...
class TaskLinker:
    ...
    def __init__(self, work_dir: str, spec_dir: Optional[str] = None):
        """
    ...
    def load_task(self, task_path: str) -> Optional[Dict]:
        """
    ...
    def group_by_feature(self, spec_path: str) -> Dict[Optional[str], List[Dict]]:
        """
        ...
        """
        feature_groups: Dict[Optional[str], List[Dict]] = {}
