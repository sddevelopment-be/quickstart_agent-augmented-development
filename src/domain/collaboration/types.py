"""
Task-related type definitions for collaboration domain.

This module provides task-specific enumerations and type aliases
used in agent orchestration and task management.
