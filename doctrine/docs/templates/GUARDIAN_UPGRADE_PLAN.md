...
| `${DOC_ROOT}/templates/architecture/ADR.md`      | Breaking Change            | ❗️ Requires manual review            | High       |
...
2. **Template Structure Change:**
   - **File:** `${DOC_ROOT}/templates/architecture/ADR.md`
...
### 4. `${DOC_ROOT}/templates/architecture/ADR.md`
...
```diff
--- ${DOC_ROOT}/templates/architecture/ADR.md (current)
+++ ${DOC_ROOT}/templates/architecture/ADR.md.framework-new
@@ Line 15
-## Decision
+## Decision Rationale
+
...
| `${DOC_ROOT}/templates/prompts/task.md`            | `local/templates/prompts/task-extended.md`  | Custom task metadata fields                     |
...
| `${DOC_ROOT}/templates/GUARDIAN_AUDIT_REPORT.md` | New Template       | Audit report format                    |
...
- `${DOC_ROOT}/templates/prompts/primer.md`
