...
**Type:** Workflow execution guide  
**Version:** 1.0.0  
**Created:** 2026-02-08  
**Author:** Curator Claire (based on SPEC-DIST-001 iteration)  
**Status:** Active
...
Provide a complete, agent-by-agent workflow for executing the 6-phase specification-driven development cycle from initial analysis through final review and merge approval.
...
**Decision Rule:** If Directive 034 says "create specification", use this tactic.
