...
| [ADR-002](ADR-002-portability-enhancement-opencode.md)          | Adopt OpenCode for Agent Portability          | 2025-11-22 | Accepted           | Adopts OpenCode specification as canonical format for agent configuration and validation.      |
...
| [ADR-016](ADR-016-agent-specific-iteration-templates.md)        | Agent-Specific Iteration Templates            | 2025-11-24 | Rejected           | Rejects specialized templates; maintains generic task templates with agent profile guidance.   |
