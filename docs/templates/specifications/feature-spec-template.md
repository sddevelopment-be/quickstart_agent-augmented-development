...
**As a** [Persona from docs/audience/]
...
**Target Personas:**
- [Persona 1] (Primary) - Link: `docs/audience/[persona].md`
- [Persona 2] (Secondary) - Link: `docs/audience/[persona].md`
...
- **Implementation Tasks:** [Link to YAML task files in work/collaboration/]
...
- Persona: `docs/audience/[persona].md`
- ADR: `docs/architecture/adrs/ADR-XXX-[title].md`
- Tests: `tests/acceptance/features/[feature].feature`
- Tasks: `work/collaboration/inbox/[timestamp]-[agent]-[feature].yaml`
