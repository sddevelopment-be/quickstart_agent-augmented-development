...
| `docs/templates/architecture/ADR.md`      | MISSING     | N/A            | Expected file not found                 |
...
| `docs/templates/prompts/task.md`         | Added local fields       | Low        | Safe to keep, document in project notes |
...
| `docs/templates/custom-template.md`      | 4 KB   | 2025-11-15    | Local template addition     |
...
- [ ] Update `work/collaboration/AGENT_STATUS.md` with Guardian completion.
